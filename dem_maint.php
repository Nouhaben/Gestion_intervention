  ...
  <div class="subnavbar-inner">
    <div class="container">
      <ul class="mainnav">
		...
		<li class="dropdown"><a 
		class="dropdown-toggle" data-toggle="dropdown"><i class=" icon-ok"></i><span>Matériels</span> </a> <b class="caret"></b>
		<ul class="dropdown-menu">
        ...
        <li><a href="messages.phpv"><i class="icon-envelope"></i><span>Mes messages</span> </a> </li>
								...
								if ( isset($_POST['submit']) ) 
{
  ...
  if($requete)
  {
	...
	echo '<script type="text/javascript">window.location.href="affect_mat.php?id='.$_GET['id'].'&id_demande='.$requete[0].' ";</script>';
								...
								<form class="form-horizontal" action="" method="post">
									<fieldset>
										<div class="login-actions">
											<center><button type="submit" name="submit" class="button btn btn-danger btn-large ">Ajouter matériel</button></center>
										</div>
