                                ...
                                <div class="box-body">
									...
									<form>
										...
										$response = mysql_query($query) or die(mysql_error());
												...
												echo"<td><a href='modifcomt_emp.php?id=".$data[0]."' class=\"btn btn-success btn-xs\">Modifier</a><b></td>";
												echo"<td><a href=\"suppcomp_emp.php?id='".$data[0]."'\" class=\"btn btn-danger btn-xs\" >Supprimer</a></td>";
