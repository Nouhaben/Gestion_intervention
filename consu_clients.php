        ...
        <div class="wrapper row-offcanvas row-offcanvas-left">
            ...
            <aside class="right-side">
                ...
                <section class="content-header">
                    <h1>
                        Bienvenue 
                        <small>groupe Sunny</small>
                    </h1>
                    <ol class="breadcrumb">
                        <li><a href="accueil.php"><i class="fa fa-dashboard"></i> Groupe Sunny</a></li>
                        <li class="active">Clients</li>
						<li class="active"><a href="consu_clients.php">Consultation clients</a></li>
                    </ol>
                </section>
                                   ...
                                   <div class="box-body table-responsive">
                                    <table id="example2" class="table table-bordered table-striped">
										...
										?>	
												...
												<td><?php echo $enreg['tel_cli'] ?><b></td>
												<td><?php echo $enreg['email_cli'] ?><b></td>
												<td><a href="tab_clients.php?id=<?php echo $enreg[0];?>" class="btn btn-info btn-xs">Consulter</a><b></td>
										<?php
