                                ...
                                <div class="box-body">
									...
									<form class="form-horizontal" action="" method="post">
											...
											<?php
												...
												$req = "select * from employes where id_emp='".$_GET['id_emp']."' ";
												$res = mysql_query($req);
											...
											?>
												<div class="control-group">											
													...
													<div class="controls">
														<input type="text" class="span6" name="id_demande" value="<?php echo $_GET['id_emp']; ?>" disabled >
                                    ...
                                    <table id="example1"class="table table-bordered table-striped">
										...
										include "config.php";
											...
											$q=mysql_query("SELECT * FROM demande where id_demande='".$_GET['id_demande']."'");
												...
												echo"</td>";
												echo"<td><a href='consu_inter_emp.php?id_demande=".$data[0]." '><input class=\"btn btn-primary btn-small\" value=\"Consulter\" ></a></td>";
												echo"</tr>";	
