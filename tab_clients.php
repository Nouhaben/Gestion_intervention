            ...
            <aside class="right-side">
                ...
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
						...
						<li class="active"><a href="consu_clients.php">Informations sur clients</a></li>
                    </ol>
                </section>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="box box-solid box-info">
                                <div class="box-header">
                                    <h3 class="box-title">Information sur le client</h3>
								...
								?>
                                    <table class="table table-bordered table-striped">
                                        <thead>
                                            <tr>
                                                <th>Raison social</th>
                                                <th><?php echo $enreg['raison_social']?></th>
                                        ...
                                        <tbody>
											<tr>
												<td>Interlocuteur</td>
												<td><?php echo $enreg['interlocuteur_cli']?></td>
											
											</tr>
											<tr>
												<td>Email</td>
												<td><?php echo $enreg['email_cli']?></td>
											
											</tr>
											<tr>
												<td>Adresse</td>
												<td><?php echo $enreg['adresse_cli']?></td>
											
											</tr>
											<tr>
												<td>Ville</td>
												<td><?php echo $enreg['ville_cli']?></td>
											
											</tr>
											<tr>
												<td>Tel</td>
												<td><?php echo $enreg['tel_cli']?></td>
											
											</tr>
											<tr>
												<td>Site web</td>
												<td><?php echo $enreg['site_web_cli']?></td>
											
											</tr>
											<tr>
												<td>Fax</td>
												<td><?php echo $enreg['fax_cli']?></td>
									...
									<form>
											<center></center>
											 <div class="box-footer clearfix no-border">
													...
													<a href="consu_clients.php"><input class="btn btn-warning pull-right" type="button" value="retour" ></a>
													<a><input class="btn btn-warning " type="button" value="Imprimer" onClick="window.print()"></a>
												</div>
									</form>
                                </div><!-- /.box-body -->
                            </div><!-- /.box -->
