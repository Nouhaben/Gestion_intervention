                        ...
                        <div class="col-md-12">
                            ...
                            <div class="box box-solid box-danger">
                                <div class="box-header">
                                    <h3 class="box-title">Gérer les matériels</h3>
                                ...
                                <div class="box-body">
                                    ...
                                    <table id="example1" class="table table-bordered table-striped">
										...
										$response = mysql_query($query) or die(mysql_error());
												...
												echo"<td><a href='table_mat.php?id=".$data[0]."' class=\"btn btn-danger btn-xs\"  onClick=\"confirme(".$data[0].")\" >Gérer son matériel</a></td>"; 
												echo"</tr>";	
												}
