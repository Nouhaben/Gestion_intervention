						  ...
						  if($requete)
							{
								...
								echo '<script type="text/javascript">window.location.href="consucomt_cli.php"</script>';
							}
						  else
							{
                                ...
                                <div class="box-body">
                                    <form action="" method="post" role="form">
                                        ...
                                        <label>Login</label>
											...
											{
													echo '<option>'.$row['email_cli'].'</option>';
												}
													echo '</select>';
										...
										<center><button name="submit" type="submit" class="btn btn-success">Ajouter</button></center>
