  ...
  <div class="subnavbar-inner">
    <div class="container">
      <ul class="mainnav">
        ...
        <li class="active"><a href="profil.php?id=<?php echo $res[0]; ?>"><i class=" icon-user"></i><span>Mon profil</span> </a> </li>
						...
						<div>
							<div class="tab-content">
								...
								<form action="" method="post">
									<fieldset>
										...
										<div class="control-group">											
											...
											<div class="controls">
												<input type="text" class="span6 disabled" id="firstname" value="<?php echo $res['raison_social'] ; ?>" disabled>
											</div> <!-- /controls -->				
										</div> <!-- /control-group -->
										
										
										<div class="control-group">											
											<label class="control-label" for="lastname">Interlocuteur</label>
											<div class="controls">
												<input type="text" class="span6 disabled" id="lastname" value="<?php echo $res['interlocuteur_cli'] ; ?>" disabled>
											</div> <!-- /controls -->				
										</div> <!-- /control-group -->
								...
								<div class="control-group">											
											...
											<div class="controls">
												<input type="text" class="span6" id="email" value="<?php echo $res['email_cli'] ; ?>">
											</div> <!-- /controls -->				
										</div> <!-- /control-group -->
										...
										<div class="control-group">											
											...
											<div class="controls">
												<input type="text" class="span6" value="<?php echo $res['adresse_cli'] ; ?>" >
											</div> <!-- /controls -->				
										</div> <!-- /control-group -->
										...
										<div class="control-group">											
											...
											<div class="controls">
												<input type="text" class="span6" value="<?php echo $res['ville_cli'] ; ?>" >
											</div> <!-- /controls -->				
										</div> <!-- /control-group -->
										...
										<div class="control-group">											
											...
											<div class="controls">
												<input type="text" class="span6" value="<?php echo $res['tel_cli'] ; ?>" >
											</div> <!-- /controls -->				
										</div> <!-- /control-group -->
										...
										<div class="control-group">											
											...
											<div class="controls">
												<input type="text" class="span6" value="<?php echo $res['site_web_cli'] ; ?>">
											</div> <!-- /controls -->				
										</div> <!-- /control-group -->
