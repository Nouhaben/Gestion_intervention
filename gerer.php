      ...
      <ul class="mainnav">
        ...
        <li><a href="messages.php?id=<?php echo $res[0]; ?>"><i class="icon-envelope"></i><span>Mes messages</span> </a> </li>
							...
							<script language="javascript">
								  ...
								  {
									var confirmation = confirme( "Voulez vous vraiment supprimer cette demande ?" ) ;
								if( confirmation )
								{
								  ...
								  {
									var confirmation = confirmer( "Voulez vous vraiment supprimer cette demande ?" ) ;
								if( confirmation )
								{
	    ...
	    <div class="container">
				<div class="row">
							...
							<div class="control-group">											
								...
								<a style="float:right" href="suppall.php" class="btn btn-danger btn-small" ><i class="btn-icon-only icon-remove"> </i></a><br><br>
								...
								<tbody>
									...
									<?php
										...
										//$response = mysql_query($q) or die(mysql_error());
												...
												echo"</td>";
												echo"<td><a href='tab_dem.php?id=".$_GET['id']."&id_demande=".$data[0]." '><input class=\"btn btn-primary btn-small\" value=\"Consulter\" ></a></a></td>";
												...
												echo "<td>";
													...
													if($date['total']==0 && $fetch[0] == 0 && $fet[0]==0){
														echo "<a href='supp_demande.php?id_demande=".$data[0]."&id=".$_GET['id']." ' class=\"btn btn-danger btn-small\" ><i class=\"btn-icon-only icon-remove\"> </i></a>";
													}
