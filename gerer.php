									...
									<div class="box-body table-responsive">
										...
										//$response = mysql_query($q) or die(mysql_error());
												...
												$my=mysql_query("SELECT count(id_demande) as total FROM confirmations where  id_demande='".$data['id_demande']."'  ");
													...
													$cpn=mysql_query("SELECT * FROM confirmations where id_demande='".$data['id_demande']."'");
												$con=mysql_fetch_array($cpn);
												
											if($con['confirmation']!='1'){
														echo"<tr>"; 
												...
												echo"<td><a href='consult.php?id_demande=".$data[0]." '><input class=\"btn btn-primary btn-xs\" value=\"Gérer\" ></a></td>";
												echo"</tr>";	
