...
<div class="subnavbar">
  <div class="subnavbar-inner">
    <div class="container">
      <ul class="mainnav">
        <li class="active"><a href="accueil.php"><i class=" icon-home"></i><span>Accueil</span> </a> </li>
					...
					<div class="plan-container">
					        ...
					        <?php
						            ...
						            <div class="plan-price">
					                	<span class="term"><?php echo "<a href=\"enattente.php\"><h2><FONT COLOR=\"red\" >".$a."&nbsp; En attente</font></h2></a>"; ?></span>
					                	<span class="term"><?php echo "<a href=\"non_regle.php\"><h2><FONT COLOR=\"yellow\">".$nr."&nbsp; Non réglé</font></h2></a>"; ?></span>
					                	<span class="term"><?php echo "<a href=\"regle.php\"><h2><FONT COLOR=\"white\">".$rg."&nbsp; Regle</font></h2></a>"; ?></span>
									</div> <!-- /plan-price -->
