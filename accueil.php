...
$req = mysql_query ("select * from employes where email_emp='".$sess."' ");
            ...
            <aside class="right-side">
                ...
                <section class="content">
                    ...
                    <div class="row">
						...
						$v=0;
						$at=0;
	$query=mysql_query("SELECT * FROM confirmations where id_emp='".$res[0]."' and confirmation='0' and responsable='1' ");
		...
		?>
									...
									$yy=mysql_query("SELECT * FROM demande where id_demande='".$mysql['id_demande']."' ");
										...
										?>
										<h3>
											   <?php echo" <center><a href='liste_demande.php?id=".$res[0]."' ><FONT COLOR=\"red\">".$at."&nbsp;En attente de confirmation</FONT></a></center><br>"; ?>
											</h3>
										
										<font size="5" face="Perpetua"><b>
											<?php echo "<center>".$nv.'&nbsp;'. 'Non vu</center>';?> 
										</font></b>
									</div>
                                </div>
...
$a=0; 
	$nr=0; $r=0;	
$que=mysql_query("SELECT * FROM confirmations where id_emp='".$res[0]."' and confirmation='1' ");
...
echo "<b><h4><FONT COLOR=\"yellow\">".$nr."&nbsp; Non réglé</font></h4></b>";
echo "<b><h4><FONT COLOR=\"white\">".$r."&nbsp; Regle</font></h3></b>";
		?>
                                </div>
