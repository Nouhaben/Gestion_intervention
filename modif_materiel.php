            ...
            <aside class="right-side">
                ...
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
						...
						<li class="active"><a href="modif_clients.php">modifier un matériel</a></li>
                    </ol>
                </section>
                        ...
                        <div class="col-md-10">
                            ...
                            <div class="box box-danger">
                                <div class="box-header">
                                    <h3 class="box-title">Modifier matériel</h3>
                                </div><!-- /.box-header -->
								...
								<?php 
									...
									$rq = "select * from materiel_cli where id_mat='".$_GET['id']."'";
									$rs = mysql_query($rq);
								...
								?>
                                    <form  action="" method="post" role="form">
										...
										<div class="form-group">
											<label>Type contrat</label>  
												<select  class="form-control" name="type_contrat">
													<option value="<?php echo $enreg['type_contrat']?>">avec contrat</option>
										...
										<input type="text" class="form-control" name="num_serie" value="<?php echo $enreg['num_serie'] ?>" />
										...
										<div class="form-group">
											...
											$q=mysql_query("SELECT * FROM clients where id_cli='".$enreg['id_cli']."'");
												echo '<select class="form-control" name="id_cli" value="<?php echo $enreg[\'id_cli\']?>" disabled>';
...
<?php echo"<input value='".$enreg['type_mat']."' type=\"text\" class=\"form-control\" name=\"type_mat\">"; ?>
										
										</div>
										<div class="form-group">
                                        <label>Marque matériel</label>
<?php echo"<input value='".$enreg['marque_mat']."' type=\"text\" class=\"form-control\" name=\"marque_mat\">"; ?>
										
										</div>

                                        <div class="form-group">
                                        <label>Designation matériel</label>
										<textarea class="form-control" rows="3" placeholder="Enter la désignation du matériel" name="desi_mat"><?php echo $enreg['desi_mat']?></textarea>
										
										</div>
										
										<div class="form-group">
											<label>Date d'achat</label>
											<input type="date" class="form-control" placeholder="Enter la date d'achat" name="date_achat" value="<?php echo $enreg['date_achat']?>">
										</div>
										
										<div class="form-group">
                                        <label>Réference d'achat</label>
										<textarea class="form-control" rows="3" placeholder="Enter la réference d'achat du matériel" name="ref_achat" ><?php echo $enreg['ref_achat']?></textarea>
										
										</div>
										
										<center><button type="submit" class="btn btn-danger">Modifier</button>
										<a href="consu_materiel.php" class="btn btn-danger" >Retour à la liste des matériels</a></center>
                                    </form>
								<?php
	...
	$ref_achat=addslashes($_POST['ref_achat']);
			  ...
			  if($requete)
			  {
				...
				echo '<script type="text/javascript">window.location.href="tab_mat.php?id='.$res[0].'";</script>';
				  }
				  else
				  {
