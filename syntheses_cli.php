            ...
            <aside class="right-side">
                ...
                <section class="content">
					...
					<?php
									...
									{ 
									$enr['id_cli'][$num] = $enreg['id_cli'];
									$enr['date_inscription'][$num] = strstr($enreg['date_inscription'], " ",true);
									$enr['raison_social'][$num] = $enreg['raison_social'];
									$enr['interlocuteur_cli'][$num] = $enreg['interlocuteur_cli'];
									$num++;
								}
                        ...
                        <div class="col-lg-12 col-xs-12">
                            ...
                            <div class="small-box bg-aqua">
                                <div class="inner">
                                    ...
                                    <p>
                                        Total clients inscrits : <h3> <?php echo count($enr['id_cli']); ?> </h3>
                                    </p>
                                </div>
                                <div class="icon">
                    ...
                    <div class="row">
                        ...
                        <section class="col-lg-12 connectedSortable"> 
                            ...
                            <h3 class="box-title">Informations sur les clients</h3>
                                </div><!-- /.box-header -->
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-12">
                                            <div class="pad">
                                                <!-- Progress bars -->
                                                <div class="clearfix">
                                                    <h4><span class="pull-left">clients inscrits aujourd'hui :</span></h4>
                                                    <small class="pull-right"><?php
													
													$client_inscrits = array_count_values($enr['date_inscription']);
													if(isset($client_inscrits[date('Y-m-d')])){
														echo $client_inscrits[date('Y-m-d')]; 
													}else{
													 echo "Aucun client n'est inscrit aujourd'hui."; 
													 }
													?></small>
                                                </div>
                                                <div class="progress">
                                                    <div  class="progress-bar progress-bar-green" role="progressbar" aria-valuenow="40" aria-valuemin="0" aria-valuemax="100" style="width: 100%"></div>
                                                </div>

                                                <div class="clearfix">
                                                    <h4><span class="pull-left">clients inscrits cette semaine :</span></h4>
                                                    <small class="pull-right"><?php
														 ...
														 if($nombretotal == 0 ) {
															echo "Aucun client n'est inscrit cette semaine.";
														 }else {
															echo $nombretotal;
														 }
														  ?></small>
                                                ...
                                                <div class="clearfix">
                                                    <h4><span class="pull-left">clients inscrits ce mois :</span></h4>
                                                    <small class="pull-right"><?php
													...
													if(isset($client_inscrits[date('Y-m')])){
													 ...
													 echo "Aucun client n'est inscrit ce mois."; 
													 }
													?></small>
                                                </div>
                                                <div class="progress">
