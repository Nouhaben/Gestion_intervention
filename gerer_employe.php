            ...
            <aside class="right-side">
                ...
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active">Empolyés</li>
						<li class="active"><a href="consu_employe.php">Gérer les employés</a></li>
                    </ol>
                </section>
                <!-- Main content -->
                <section class="content">
					...
					<div class="row">
						...
						<script language="javascript">
								  ...
								  {
									var confirmation = confirm( "Voulez vous vraiment supprimer cet employe ?" ) ;
								if( confirmation )
								{
								  document.location.href = "supp_employe.php?id_emp="+id ;
								}
								  }
								</script>	
                        <div class="col-xs-15">
                                  ...
                                  <div class="box-body table-responsive">
                                    <table id="example1" class="table table-bordered table-striped">
										...
										$response = mysql_query($query) or die(mysql_error());
												...
												echo"<td>".$data['prenom_emp']."<b></td>";
												echo"<td>".$data['fonction_emp']."<b></td>";
												
												echo"<td><a href='modif_employe.php?id=".$data[0]."' class=\"btn btn-success btn-xs\">Modifier</a><b></td>";
												echo"<td><a href=\"#\" class=\"btn bg-maroon btn-xs\" onClick=\"confirme(".$data[0].")\" >Supprimer</a></td>";
												echo"</tr>";	
												}	?>
