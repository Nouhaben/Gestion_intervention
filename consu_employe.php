            ...
            <aside class="right-side">
                ...
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
						...
						<li class="active"><a href="consu_employe.php">Consultations employés</a></li>
                    </ol>
                </section>
                <!-- Main content -->
                                  ...
                                  <div class="box-body table-responsive">
                                    <table id="example1" class="table table-bordered table-striped">
										...
										$response = mysql_query($query) or die(mysql_error());
												...
												echo"<tr >"; 
												echo"<td><a href='tab_emp.php?id=".$data[0]."' >".$data['nom_emp']."</a></td>"; 
												echo"<td>".$data['prenom_emp']."<b></td>";
												echo"<td>".$data['fonction_emp']."<b></td>";
												
												echo"<td>" .$data['service_emp']."<b></td>";
												echo"<td>".$data['email_emp']."<b></td>";
												echo"<td>".$data['tel_emp']."<b></td>";
												echo"</tr>";	
												}	?>
