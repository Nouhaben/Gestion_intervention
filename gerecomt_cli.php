        ...
        <div class="wrapper row-offcanvas row-offcanvas-left">
            ...
            <aside class="right-side">
				...
				<script language="javascript">
								  ...
								  {
									var confirmation = confirm( "Voulez vous vraiment supprimer ce compte ?" ) ;
								if( confirmation )
								{
								  document.location.href = "suppcomp_cli.php?id="+id ;
								}
								  }
                                ...
                                <div class="box-body">
									...
									<form>
										...
										$response = mysql_query($query) or die(mysql_error());
												...
												echo"<td><a href='modifcomt_cli.php?id=".$data[0]."' class=\"btn btn-success btn-xs\">Modifier</a><b></td>";
												echo"<td><a href=\"suppcomp_cli.php?id='".$data[0]."'\" class=\"btn btn-danger btn-xs\" >Supprimer</a></td>";
