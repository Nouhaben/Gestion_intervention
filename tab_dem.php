...
if($_GET['id_demande']){
$r = "UPDATE demande SET etat = 'vu' where id_demande='".$_GET['id_demande']."' ";
						...
						<div class="col-md-12">
								...
								<form class="form-horizontal" action="" method="post">
											...
											?>
												<div class="control-group">											
													...
													<div class="controls">
														<input type="text" name="id_demande" value="<?php echo $_GET['id_demande']; ?>" disabled >
													<?php
										...
										?>
													<button type="submit" name="confirmer"  class="button btn btn-success">Confirmer</button>
										<?php
											...
											<?php 
												...
												if(isset($_POST['confirmer'])){
													$reque = "UPDATE confirmations SET confirmation = '1'where id_demande='".$_GET['id_demande']."' ";
													$requete = mysql_query($reque) or die( mysql_error() );
													...
													$re = mysql_query($r) or die( mysql_error() );
													  ...
													  if($requete)
													  {
														echo '<script type="text/javascript">alert("Vous avez confirmer la demande")</script>';
														echo '<script type="text/javascript">window.location.href="list_dem.php?id='.$res[0].'";</script>';
														  ...
														  {
														echo '<script type="text/javascript">alert("La confirmation est échouée")</script>';
														  }
												}	
													else{}
												}
							...
							<div class="form-group">
								...
								<?php
										...
										//$response = mysql_query($q) or die(mysql_error());
												...
												echo"<td>";
													$aff=mysql_query("SELECT COUNT(id_demande) FROM interventions WHERE id_demande='".$data['id_demande']."' and id_mat='".$date['id_mat']."' ");
												$don=mysql_fetch_array($aff);
														...
														$aff1=mysql_query("SELECT * FROM interventions WHERE id_demande='".$data['id_demande']."' and id_mat='".$date['id_mat']."' ");		
														$etat=false;
							...
							<form class="form-horizontal" action="" method="post">
								<fieldset>
									...
									<div class="control-group">	
										...
										?>
											...
											<label class="control-label" for="firstname">votre excuse</label>
											<div class="controls">
												<textarea class="form-control" rows="3" placeholder="Enter votre excuse" name="excuse" ></textarea><br>
												
												<button type="submit" name="excuser" class="button btn btn-danger ">s'excuser</button>
										...
										?>
													...
													<input style="float:right" class="btn-danger"  value="s'excusé" disabled>
								...
								<?php 
									...
									if(isset($_POST['excuser']) && !empty($_POST['excuse'])){
										$don = "UPDATE confirmations SET confirmation = '2', 
										excuse='".$_POST['excuse']."' where id_demande='".$_GET['id_demande']."' ";
										$qu = mysql_query($don) or die( mysql_error() );
											...
											if($qu)
												{
													echo '<script type="text/javascript">alert("Vous excuse est bien envoyé")</script>';
													echo '<script type="text/javascript">window.location.href="list_dem.php?id='.$res[0].'";</script>';
												}
											else
												{
													echo '<script type="text/javascript">alert("votre excuse est mal envoyé, veuillez ressayer ")</script>';
												}
									}	
									else{}
