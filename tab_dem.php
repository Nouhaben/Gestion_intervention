  ...
  <div class="subnavbar-inner">
    <div class="container">
      <ul class="mainnav">
        ...
        <li class="dropdown"><a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown"><i class=" icon-ok"></i><span>Matèriels</span> </a> <b class="caret"></b>
		<ul class="dropdown-menu">
			<li><a href="ajou_mat.php">Ajouter matèriel</a></li>
...
<script language="javascript">
								...
								if( confirmation )
								{
								  document.location.href = "supp_listmat.php?id_limat="+id ;
								}
								  }
						</script>
								...
								<?php
														...
														if(isset($_GET['id_demande']))
										{
											...
											$qur=mysql_query("SELECT * FROM demande where id_demande='".$_GET['id_demande']."'");
												...
												echo "<td><a href='modif_pro.php?id_limat=".$data[0]."&id_demande=".$data[0]."  ' class=\"btn btn-small btn-success\"><i class=\"btn-icon-only icon-ok\"> </i></a></td>";
												echo "<td><a href=\"#\" class=\"btn btn-danger btn-small\" onClick=\"confirme(".$data[0].")\"><i class=\"btn-icon-only icon-remove\"> </i></a></td>";
												echo"</tr>";	
												}
											}	
