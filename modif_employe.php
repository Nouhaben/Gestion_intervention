                        ...
                        <li class="dropdown user user-menu">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li class="user-header bg-light-blue">
                                    <img src="img/avatar3.png" class="img-circle" alt="User Image" />
                                    <p><?php echo $res['email'] ; ?> - <?php echo $res['email'] ; ?>
                                    </p>
                                </li>
                                <!-- Menu Footer-->
            ...
            <aside class="right-side">
                ...
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
						...
						<li class="active">Modifier un employé</li>
                    </ol>
                </section>
                        ...
                        <div class="col-md-10">
                            ...
                            <div class="box box-warning">
                                <div class="box-header">
                                    <h3 class="box-title">Modifier employe</h3>
                                </div><!-- /.box-header -->
                                <div class="box-body">
							...
							<?php
									...
									$req = "select * from employes where id_emp='".$_GET['id']."' ";
									$res = mysql_query($req);
                                    ...
                                    <form role="form" action="" method="post">
										...
										<div class="form-group">
											...
											<div class="input-group">    
											 ...
											 <input type="text" class="form-control" placeholder="Enter le nom" name="nom_emp" value="<?php echo $enreg['nom_emp']?>" />
											</div>
										</div>
										<div class="form-group">
											...
											<div class="input-group">
												<span class="input-group-addon"><div  class="fa fa-user"> </div></span>
												<input type="text" class="form-control" placeholder="Enter le prenom" name="prenom_emp" value="<?php echo $enreg['prenom_emp']?>" />
											</div>
										</div>
										...
										<div class="form-group">
											<div class="input-group">
												...
												<input type="text" class="form-control" placeholder="Enter la fonction" name="fonction_emp" value="<?php echo $enreg['fonction_emp']?>" >
											</div>
										</div>
										<div class="form-group">
											...
											<div class="input-group">
												...
												<input type="text" class="form-control" placeholder="Enter le service" name="service_emp" value="<?php echo $enreg['service_emp']?>" >
											</div>
										</div>
										...
										<div class="form-group">
											<div class="input-group">
												...
												<input type="text" class="form-control" placeholder="Enter l'email" name="email_emp" value="<?php echo $enreg['email_emp']?>" >
											</div>
										</div>
...
<?php echo"<input value='".$enreg['adresse_emp']."' type=\"text\" class=\"form-control\" name=\"adresse_emp\">"; ?>
										...
										<div class="form-group">
											...
											<div class="input-group">
												...
												<input type="text" class="form-control" placeholder="Enter la ville" name="ville_emp" value="<?php echo $enreg['ville_emp']?>" >
											</div>
										</div>
										...
										<div class="form-group">
											...
											<div class="input-group">
												...
												<input type="text" class="form-control" placeholder="Enter le telephone" name="tel_emp"  data-inputmask='"mask": "(9999) 99-99-99"' data-mask value="<?php echo $enreg['tel_emp']?>"/>
											</div>
										</div>
										
										<center><button class="btn btn-warning">Modifier</button></center>
				...
				if ( isset($_POST['nom_emp']) && isset($_POST['prenom_emp']) ) {
					$nom_emp=$_POST['nom_emp'];
					$prenom_emp=$_POST['prenom_emp'];
					$fonction_emp=$_POST['fonction_emp'];
					$service_emp=$_POST['service_emp'];
					$email_emp=$_POST['email_emp'];
					$adresse_emp=addslashes($_POST['adresse_emp']);
					$ville_emp=$_POST['ville_emp'];
					$tel_emp=$_POST['tel_emp'];
					
					$sql = "update employes set nom_emp = '".$nom_emp."', 
					prenom_emp = '".$prenom_emp."' ,
					fonction_emp = '".$fonction_emp."' , 
					service_emp = '".$service_emp."' , 
					email_emp = '".$email_emp."' ,
					adresse_emp = '".$adresse_emp."' , 
					ville_emp = '".$ville_emp."' ,
					tel_emp = '".$tel_emp."' 
					where id_emp ='".$_GET['id']."' ;";
			  ...
			  if($requete)
			  {
				...
				echo '<script type="text/javascript">window.location.href="gerer_employe.php";</script>';
				  }
				  else
				  {
