...
if ( isset($_POST['num_serie']) ) {
	...
	$sql = "INSERT INTO materiel(type_contrat,num_serie,id_cli,type_mat,marque_mat,desi_mat,date_achat,ref_achat) VALUES('$type_contrat','$num_serie', '$id_cli','$type_mat','$marque_mat','$desi_mat','$date_achat','$ref_achat')";
                                ...
                                <div class="box-body">
									...
									<table id="example1" class="table table-bordered table-striped">
										...
										$response = mysql_query($query) or die(mysql_error());
												...
												echo"<td><a href='tab_mat.php?id=".$data[0]."' class=\"btn btn-primary btn-large\"  onClick=\"confirme(".$data[0].")\" >Consulter son matériel</a></td>"; 
												echo"</tr>";	
												}
