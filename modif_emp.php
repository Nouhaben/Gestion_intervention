						...
						<div class="col-md-12">
                            ...
                            <div class="box box-warning">
                                <div class="box-header">
                                    <h3 class="box-title">Gérer les affectations</h3>
								...
								<div class="box-body">
									...
									<div class="control-group">											
											<label class="control-label" for="firstname">Employé affecté</label>
												<div class="controls">
													<?php	
										
														$q=mysql_query("SELECT * FROM employes where id_emp='".$_GET['id_emp']."' ");
															echo '<select name="id_emp" class="form-control" disabled>';
									...
									<div class="control-group">											
											<label class="control-label" for="firstname">affecter un autre employé</label>
												<div class="controls">
													<?php	
										...
										<div class="control-group">											
											...
											<div class="login-actions">
												<center><button type="submit" name="submit" class="button btn btn-success ">Modifier</button></center>
											</div>
										</div><br>
