            ...
            <aside class="right-side">
                ...
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
						...
						<li class="active"><a href="consu_clients.php">Consultation employés</a></li>
                    </ol>
                </section>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="box box-solid box-warning">
                                <div class="box-header">
                                    <h3 class="box-title">Listes des employés</h3>
								...
								if( confirmation )
								{
								  document.location.href = "supp_clients.php?id_cli="+id ;
								}
								  }
								</script>
                        <div class="col-xs-15">
                            <div class="box">
                                <div class="box-body">
                                  <?php 
										...
										$query ="SELECT * FROM employes where id_emp='".$_GET['id']."'";
								...
								?>
                                    <table class="table table-bordered table-striped">
                                        ...
                                        <tbody>
											<tr>
                                                <td>nom employé</td>
                                                <td><?php echo $enreg['nom_emp']?></td>
                                                
                                            </tr>
											<tr>
												<td>prénom employé</td>
												<td><?php echo $enreg['prenom_emp']?></td>
											
											</tr>
											<tr>
												<td>Fonction employé</td>
												<td><?php echo $enreg['fonction_emp']?></td>
											
											</tr>
											<tr>
												<td>Service </td>
												<td><?php echo $enreg['service_emp']?></td>
											
											</tr>
											<tr>
												<td>Ville</td>
												<td><?php echo $enreg['email_emp']?></td>
											
											</tr>
											<tr>
												<td>Adresse employé</td>
												<td><?php echo $enreg['adresse_emp']?></td>
											
											</tr>
											<tr>
												<td>Ville employé</td>
												<td><?php echo $enreg['ville_emp']?></td>
											
											</tr>
											<tr>
												<td>Tél employé</td>
												<td><?php echo $enreg['tel_emp']?></td>
									...
									<form>
											<a href="consu_employe.php"><input class="btn btn-warning pull-right" type="button" value="retour" ></a>
											<a><input class="btn btn-info " type="button" value="Imprimer" onClick="window.print()"></a>
