                                ...
                                <div class="box-body">
									<form class="form-horizontal" action="" method="post">
											...
											<?php
												...
												$rq = "select * from employes where id_emp='".$_GET['id_emp']."' ";
												$rs = mysql_query($rq);
											...
											?>
												<div class="control-group">											
													<label class="control-label" for="firstname">l'employé</label>
													<div class="controls">
														<input type="text" class="form-control" name="id_demande" value="<?php echo $enreg['nom_emp'].'&nbsp;'.$enreg['prenom_emp']; ?>" disabled >
                                    ...
                                    <table id="example2" class="table table-bordered table-striped">
                                        <thead>
                                            <tr>
                                                ...
                                                <th>responsable</th>
                                                <th>Confirmation</th>
												<th>Consulter ces affectation</th>
										...
										$query ="SELECT * FROM confirmations where id_emp='".$_GET['id_emp']."' ORDER BY  `confirmations`.`id_demande` DESC";
										$response = mysql_query($query) or die(mysql_error());
												...
												echo"<td>";
													if($data['confirmation']=='0'){
														echo "<input class=\"button btn btn-warning btn-xs\" value=\"En attente\" disabled>" ;}
													elseif($data['confirmation']=='1') {
														echo "<input class=\"button btn btn-success btn-xs\" value=\"Confirmé\" disabled>" ; 
														}
													else
														 echo "<input class=\"button btn btn-danger btn-xs\" value=\"S'excusé\" disabled>" ;				
												echo"</td>";
												...
												echo"<td>";
													if($data['confirmation']=='2'){
														...
														echo "<a href='inter_emp.php?id_demande=".$data['id_demande']."' class=\"btn btn-success btn-xs\"  >Consulter ces interventions</a>";
