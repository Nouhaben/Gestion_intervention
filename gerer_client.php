...
<html>
    ...
    <body class="skin-blue">
            ...
            <aside class="right-side">
                ...
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
						...
						<li class="active"><a href="consu_clients.php">Gérer les clients</a></li>
                    </ol>
                </section>
                                ...
                                <div class="box-body">
                                  <div class="box-body table-responsive">
                                    <table id="example2" class="table table-bordered table-striped">
										...
										$query ="SELECT * FROM clients ORDER BY  `clients`.`id_cli` DESC ";
		...
		?>
												...
												<tr > 
												<td><?php echo $enreg['id_cli']; ?></td>
												<td> <?php echo $enreg['raison_social']; ?><b></td>
												<td><?php echo $enreg['interlocuteur_cli'] ?><b></td>
												<td><a href="modif_clients.php?id=<?php echo $enreg[0]; ?>" class="btn btn-warning btn-xs" >Modifier</a><b></td>
												<td><a href="#"  class="btn btn-danger btn-xs"  onClick="confirme(<?php echo $enreg[0]; ?>)" >Supprimer</a></td>
