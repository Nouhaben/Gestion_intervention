                        ...
                        <div class="col-md-12">
                            ...
                            <div class="box box-solid box-danger">
                                <div class="box-header">
                                    <h3 class="box-title">Affecter matériel aux clients</h3>
                                  ...
                                  <div class="box-body table-responsive">
                                    <table id="example2" class="table table-bordered table-striped">
										...
										$response = mysql_query($query) or die(mysql_error());
												...
												echo"<tr >"; 
												echo"<td>".$data['id_cli']."</a></td>"; 
												echo"<td>".$data['raison_social']."<b></td>";
												echo"<td>".$data['interlocuteur_cli']."<b></td>";
												echo"<td><a href='ajou_mat.php?id=".$data[0]."' class=\"btn btn-warning btn-xs\" >Affecter matériel</a><b></td>";
