                        ...
                        <div class="col-md-12">
                            ...
                            <div class="box box-solid box-success">
                                <div class="box-header">
                                    <h3 class="box-title">Consultations les demandes selon chaque employé</h3>
                            ...
                            <div class="box">
                                <div class="box-body">
                                    ...
                                    <table id="example2" class="table table-bordered table-striped">
										...
										$query ="SELECT * FROM employes ORDER BY  `employes`.`id_emp` DESC ";
										$response = mysql_query($query) or die(mysql_error());
												...
												echo"<tr >"; 
												echo"<td>".$data['id_emp']."</td>"; 
												echo"<td>".$data['nom_emp']."<b></td>";
												echo"<td>".$data['prenom_emp']."<b></td>";
												echo"<td>".$data['fonction_emp']."<b></td>";
												echo"<td>".$data['service_emp']."<b></td>";
												echo"<td><a href='tab_emp.php?id_emp=".$data[0]."' class=\"btn btn-success btn-xs\"  >Consulter ces affectation</a></td>";
