						...
						<div class="col-md-12">
                            ...
                            <div class="box box-warning">
								...
								<div class="box-body">
									...
									<form method="post">
									<?php
										$aff=mysql_query("SELECT COUNT(id_demande) FROM interventions WHERE id_demande='".$_GET['id_demande']."' ");
										 ...
										 if(isset($_GET['id_demande']))
										{
                                            ...
                                            $r=mysql_query("select * from materiel_cli where id_mat='".$data['id_mat']."' ");
												...
												$o=mysql_fetch_array($a1);
													...
													if($o['piec_rech']=='Oui'){
														echo" <a href='consu_piece.php?id_intervention=".$o['id_intervention']."'><input class=\"btn btn-warning btn-xs\" value=\"Consulter\" ></a>";
