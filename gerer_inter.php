								...
								<div class="box-body">
										 ...
										 if(isset($_GET['id']))
										{
											...
											$data=mysql_fetch_array($q);
												...
												$ql=mysql_query("SELECT * FROM confirmations where id_demande='".$data['id_demande']."'");
												...
												echo"</td>";
												echo"<td><a href='consu.php?id_demande=".$data[0]." '><input class=\"btn btn-primary btn-xs \" value=\"Gérer\" ></a></td>";
												echo"</tr>";	
												}}
												}}
