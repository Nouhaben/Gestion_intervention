	...
	<div class="main-inner">
	    ...
	    <div class="container">
				<div class="row">
							...
							<div class="span12">
								...
								<?php 
									...
									$rq = "select * from list_mat where id_limat='".$_GET['id_limat']."'";
									$rs = mysql_query($rq);
			  ...
			  if($requete)
			  {
				...
				echo '<script type="text/javascript">window.location.href="tab_dem.php?id='.$res[0].'&id_demande='.$enreg['id_demande'].'";</script>';
