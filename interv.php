                    ...
                    <div class="row">
						...
						<div class="col-md-10">
                            ...
                            <div class="box box-danger">
								...
								<?php
										...
										//$response = mysql_query($q) or die(mysql_error());
												...
												echo"<tr>"; 
													...
													echo "<td>"; echo $date['type_mat'].'&nbsp;'.$date['marque_mat'].'&nbsp;'.$date['desi_mat'] ; echo"</td>";
							  ...
							  <h3><u>Saisissez votre interventions :</u></h3><br>
							<form class="form-horizontal" action="" method="post">
								<fieldset>
									<div class="control-group">											
										<label class="control-label" for="firstname">Problème</label>
											<div class="controls">
												<textarea class="form-control" rows="3" name="probleme_inter" ><?php echo $data['probleme_demande'] ?></textarea>
											</div>
									</div><br>
								<?php 	}
								...
								<div class="control-group">											
										<label class="control-label" for="firstname">Interventions</label>
											<div class="controls">
												<textarea class="form-control" rows="3" placeholder="Enter votre interventions" name="interventions" ></textarea>
											</div>
									</div><br>
									...
									<div class="control-group">											
										<label class="control-label" for="firstname">Observations</label>
											<div class="controls">
												<textarea class="form-control" rows="3" placeholder="Enter votre observations" name="observation" ></textarea>
											</div>
									</div><br>
									...
									<div class="control-group">											
										<label class="control-label" for="firstname">Date Intervention</label>
											<div class="controls">
												<input  class="form-control" name="date_inter" value="<?php echo date('Y/m/d'); ?>">
											</div>
									</div><br>
									...
									<div class="control-group">											
										<label class="control-label" for="firstname">Heure Intervention</label>
											<div class="controls">
												<input class="form-control" name="heure_inter" value="<?php echo date('H:i'); ?>">
											</div>
									</div><br>
									...
									<div class="control-group">											
										<label class="control-label" for="firstname">Date prochaine interventions</label>
											<div class="controls">
												<input type="date" class="form-control" name="date_prochaine_inter" >
											</div>
									</div><br>
									...
									<div class="login-actions">
										<button style="float:right" type="submit" name="submit" class="button btn btn-info btn-large ">Suivant</button>
								...
								if ( isset($_POST['submit']) ) 
								{
									...
									$id_mat=$_GET['id_mat'];
									$probleme_inter=addslashes($_POST['probleme_inter']);
									$interventions=addslashes($_POST['interventions']);
									...
									mysql_query("INSERT INTO interventions (id_demande,id_mat,probleme_inter,interventions,observation,date_inter,heure_inter,regle,date_prochaine_inter,piec_rech,etat) VALUES ('$id_demande','$id_mat','$probleme_inter','$interventions','$observation','$date_inter','$heure_inter','$regle','$date_prochaine_inter','$piec_rech','non vu') ");
									$ma=mysql_query("select MAX(id_intervention) from interventions");
									$requete=mysql_fetch_array($ma);
									  ...
									  if($requete)
									  {
										...
										echo '<script type="text/javascript">window.location.href="piece_rechange.php?id_demande='.$_GET['id_demande'].'&id_intervention='.$requete[0].' ";</script>';
