                    ...
                    <div class="row">
						...
						<div class="col-md-12">
                            ...
                            <div class="box box-warning">
								...
								if( confirmation )
								{
								  document.location.href = "supp_emp.php?id_conf="+id ;
								}
								  }
													...
													<?php
															...
															if(isset($_GET['id_demande']))
															{
																...
																$q=mysql_query("SELECT * FROM confirmations where id_demande='".$_GET['id_demande']."'");
																	...
																	echo"<td><a href='modif_emp.php?id_demande=".$_GET['id_demande']."&id_emp=".$data['id_emp']." '><input class=\"btn btn-info btn-xs \" value=\"Modifier\" ></a></td>";
												
																	echo"<td><a href='#' onClick=\"confirme(".$data[0].")\" ><input class=\"btn btn-primary btn-xs \" value=\"Supprimer\" ></a></td>";
