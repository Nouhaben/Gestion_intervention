							  ...
							  <table class="table table-striped table-bordered">
								...
								<?php
										...
										//$response = mysql_query($q) or die(mysql_error());
												...
												echo"<td>";
													$aff=mysql_query("SELECT COUNT(id_demande) FROM interventions WHERE id_demande='".$_GET['id_demande']."' and id_mat='".$data['id_mat']."' ");
												$don=mysql_fetch_array($aff);
														...
														$aff1=mysql_query("SELECT * FROM interventions WHERE id_demande='".$_GET['id_demande']."' and id_mat='".$data['id_mat']."' ");		
														$etat=false;
