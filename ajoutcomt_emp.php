            ...
            <aside class="right-side">
                ...
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
						...
						<li class="active"><a href="ajoucomt_cli.php">Ajouter un compte pour les employés</a></li>
                    </ol>
                </section>
									<?php 
					...
					if ( isset($_POST['submit'])) {
						...
						$requete = mysql_query($sql) or die( mysql_error() ) ;
						  ...
						  if($requete)
							{
								echo '<script type="text/javascript">alert("Le compte du client est bien ajouté");</script>';
								echo '<script type="text/javascript">window.location.href="consucomt_emp.php"</script>';
							}
						  else
							{
							...
							echo '<script type="text/javascript">alert("vous avez pas bien confirmé votre mot de passe ");</script>';
						 } }
?>
                <!-- Main content -->
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="box box-primary">
                                <div class="box-header">
                                    <h3 class="box-title">Ajouter un nouveau compte employé</h3>
                                </div><!-- /.box-header -->
                                <div class="box-body">
                                    <form action="" method="post" role="form">
                                        ...
                                        <label>Mot de passe</label>
											<div class="input-group">
												...
												<input type="password" class="form-control" placeholder="Enter le mot de passe" name="password" />
											</div><br>
										</div>
										<div class="form-group">
                                        ...
                                        <label>Rôle</label>
											<div class="input-group">
												...
												$q=mysql_query("SELECT * FROM role ");
										...
										<center><button name="submit" type="submit" class="btn btn-primary">Ajouter</button></center>
