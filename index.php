...
session_start();
       ...
       if (isset($_POST['email']) ){
           ...
           $password = $_POST['password'];
			...
			$query = mysql_query ("SELECT * from users where email = '".$email."' and password='".$password."' and role='directeur' " );
    ...
    <body class="bg-black">
        ...
        <div class="form-box" id="login-box">
            ...
            <form action="" method="post">
                ...
                <div class="footer">                                                               
                    <button type="submit" class="btn bg-blue btn-block">Connexion</button>  
