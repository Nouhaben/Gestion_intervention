...
if ( isset($_POST['nom_emp']) && isset($_POST['prenom_emp']) ) {
	...
	$sql = "INSERT INTO employes(nom_emp,prenom_emp,fonction_emp,service_emp,email_emp,adresse_emp,ville_emp,tel_emp) VALUES('$nom_emp','$prenom_emp','$fonction_emp','$service_emp','$email_emp','$adresse_emp','$ville_emp','$tel_emp')";
	$requete = mysql_query($sql) or die( mysql_error() ) ;
 
	  if($requete)
	  {
		echo '<script type="text/javascript">alert("L\'employé est bien ajouté");</script>';
        ...
        <div class="wrapper row-offcanvas row-offcanvas-left">
            ...
            <aside class="right-side">
                ...
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        <li><a href="accueil.php"><i class="fa fa-dashboard"></i> Groupe Sunny</a></li>
                        <li class="active">Employés</li>
						<li class="active"><a href="ajout_employe.php">Ajouter un employé</a></li>
                    </ol>
                </section>
                        ...
                        <div class="col-md-10">
                            ...
                            <div class="box box-warning">
                                <div class="box-header">
                                    <h3 class="box-title">Ajouter employe</h3>
                                </div><!-- /.box-header -->
                                <div class="box-body">
                                    <form role="form" action="" method="post">
										...
										<div class="form-group">
											...
											<div class="input-group">    
											 ...
											 <input type="text" class="form-control" placeholder="Enter le nom" name="nom_emp"/>
											</div>
										</div>
										<div class="form-group">
											...
											<div class="input-group">
												<span class="input-group-addon"><div  class="fa fa-user"> </div></span>
												<input type="text" class="form-control" placeholder="Enter le prenom" name="prenom_emp" />
											</div>
										</div>
										...
										<div class="form-group">
											<div class="input-group">
												...
												<input type="text" class="form-control" placeholder="Enter la fonction" name="fonction_emp">
											</div>
										</div>
										<div class="form-group">
											...
											<div class="input-group">
												...
												<input type="text" class="form-control" placeholder="Enter le service" name="service_emp">
											</div>
										</div>
										...
										<div class="form-group">
											<div class="input-group">
												...
												<input type="text" class="form-control" placeholder="Enter l'email" name="email_emp">
											</div>
										</div>
										...
										<div class="form-group">
											...
											<div class="input-group">
												...
												<input type="text" class="form-control" placeholder="Enter l'adresse" name="adresse_emp">
											</div>
										</div>
										...
										<div class="form-group">
											...
											<div class="input-group">
												...
												<input type="text" class="form-control" placeholder="Enter la ville" name="ville_emp">
											</div>
										</div>
										...
										<div class="form-group">
											...
											<div class="input-group">
												...
												<input type="text" class="form-control" placeholder="Enter le telephone" name="tel_emp" />
											</div>
										</div>
										
										<center><button class="btn btn-warning">Ajouter</button></center>
