											...
											if(isset($_GET['id_demande']))
										{
											...
											?>
												<div class="control-group">											
													...
													<div class="controls">
														<input type="text" class="form-control" name="id_demande" value="<?php echo $dat['raison_social']; ?>" disabled >
													
													</div> <!-- /controls -->	
												</div>
												
												<div class="control-group">											
													<label class="control-label" for="firstname">Interlocuteur</label>
													<div class="controls">
														<input type="text" class="form-control" name="id_demande" value="<?php echo $dat['interlocuteur_cli']; ?>" disabled >
								...
								<?php
										...
										//$response = mysql_query($q) or die(mysql_error());
												...
												echo"<td>";
													...
													echo" <a href='interv.php?id_mat=".$date['id_mat']."&id_demande=".$_GET['id_demande']." '><input class=\"btn btn-info btn-xs\" value=\"Ajouter\" ></a>";
												echo"</td>";
												...
												echo"<td>";
													...
													echo" <a href='pdf_inter.php?id_mat=".$date['id_mat']."&id_demande=".$_GET['id_demande']." '  ><button  class=\"btn btn-success \" >
