            ...
            <aside class="right-side">
                ...
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active">Matériels</li>
						<li class="active"><a href="consu_clients.php">Consultation Matériel</a></li>
                    </ol>
                </section>
				<script language="javascript">
								...
								if( confirmation )
								{
								  document.location.href = "supp_materiel.php?id_mat="+id ;
								}
								  }
								</script>
                <!-- Main content -->
                            ...
                            <div class="box">
								...
								?>
										...
										<?php
										 ...
										 if(isset($_GET['id']))
										{
										$query ="SELECT * FROM  materiel_cli where id_cli='".$_GET['id']."' ";
										$response = mysql_query($query) or die(mysql_error());
												...
												echo"<td><a href='modif_materiel.php?id=".$data[0]."' class=\"btn bg-olive btn-xs\">Modifier</a><b></td>";
												echo"<td><a href=\"#\" class=\"btn bg-purple btn-xs\" onClick=\"confirme(".$data[0].")\" >Supprimer</a></td>";
