            ...
            <aside class="right-side">
                ...
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
						...
						<li class="active"><a href="consu_clients.php">Consultation matériels</a></li>
                    </ol>
                </section>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="box box-solid box-danger">
                                <div class="box-header">
                                    <h3 class="box-title">Consultations des matériels</h3>
                                ...
                                <div class="box-body">
                                    ...
                                    <table id="example1" class="table table-bordered table-striped">
										...
										$response = mysql_query($query) or die(mysql_error());
												...
												echo"<td><a href='tab_mat.php?id=".$data[0]."' class=\"btn btn-danger btn-xs\"  onClick=\"confirme(".$data[0].")\" >Consulter son matériel</a></td>"; 
												echo"</tr>";	
												}
