                    ...
                    <div class="row">
						...
						<div class="col-md-12">
							...
							if(isset($_GET['id_pr']))
								...
								$requete = "select * from pieces_rechange where id_pr='".$_GET['id_pr']."' ";
								$enreg = mysql_query($requete);
								$resultat=mysql_fetch_array($enreg);
								...
								<fieldset>
									<div class="control-group">											
										<label class="control-label" for="firstname">Pièce</label>
											<div class="controls">
<?php echo"<input value='".$resultat['pieces_pr']."' type=\"text\" class=\"form-control\" name=\"pieces_pr\">"; ?>
											</div>
									</div>
									...
									<div class="control-group">											
										<label class="control-label" for="firstname">Designation</label>
											<div class="controls">
												<textarea class="form-control" rows="3"  name="desi_pr"  ><?php echo $resultat['desi_pr'] ?></textarea>
											</div>
									</div>
									...
									<div class="control-group">											
										<label class="control-label" for="firstname">Quantité</label>
											<div class="controls">
												<input type="text" class="form-control" name="quantite"  value="<?php echo $resultat['quantite'] ?>">
											</div>
									</div>
									<br><br>
									<div class="login-actions">
										<center><button type="submit" name="modif" class="button btn btn-info btn-large ">Modifier</button></center>
									</div>
								</fieldset>
							</form>
					...
					$pieces_pr=$_POST['pieces_pr'];
					$desi_pr=$_POST['desi_pr'];
					$quantite=$_POST['quantite'];
					
					
					$sql = "update pieces_rechange set pieces_pr = '".$pieces_pr."', 
					desi_pr = '".$desi_pr."' ,
					quantite = '".$quantite."' 
					where id_pr='".$_GET['id_pr']."' ;";
