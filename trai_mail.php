...
$sql = "SELECT email FROM users WHERE email = '".$email."' and role='employe' ";
...
$retour = mysql_query("SELECT * FROM employes WHERE email_emp = '".$req['email']."' ");
$message = "Employé :".$retour['nom_emp'].'&nbsp'. $retour['prenom_emp'];
