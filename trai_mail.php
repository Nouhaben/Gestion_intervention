...
$sql = "SELECT email FROM users WHERE email = '".$email."' and role='client' ";
...
$retour = mysql_query("SELECT * FROM clients WHERE email_cli = '".$req['email']."' ");
$message = "Client :".$retour['interlocuteur_cli'];
