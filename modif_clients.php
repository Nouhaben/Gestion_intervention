            ...
            <aside class="right-side">
                ...
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
						...
						<li class="active"><a href="modif_clients.php">modifier un client</a></li>
                    </ol>
                </section>
...
<?php echo"<input value='".$enreg['raison_social']."' type=\"text\" class=\"form-control\" name=\"raison_social\">"; ?>
											</div>
										</div>
										<div class="form-group">
...
<input type="text" class="form-control" placeholder="Enter le nom et prenom" name="interlocuteur_cli" value="<?php echo $enreg['interlocuteur_cli']?>"/>
											</div>
										</div>
										<div class="form-group">
                                        <label>Email</label>
											<div class="input-group">
												...
												<input type="text" class="form-control" placeholder="Enter l'email" name="email_cli" value="<?php echo $enreg['email_cli']?>">
											</div>
										</div>
                                        ...
                                        <label>Adresse</label>
											<div class="input-group">
												...
												<input type="text" class="form-control" placeholder="Enter l'adresse" name="adresse_cli" value="<?php echo $enreg['adresse_cli']?>">
											</div>
										</div>
                                        ...
                                        <label>Ville</label>
											<div class="input-group">
												...
												<input type="text" class="form-control" placeholder="Enter la ville" name="ville_cli" value="<?php echo $enreg['ville_cli']?>">
											</div>
										</div>
                                        ...
                                        <label>Tel</label>
											<div class="input-group">
												...
												<input type="text" class="form-control" placeholder="Enter le telephone" name="tel_cli" value="<?php echo $enreg['tel_cli']?>" data-inputmask='"mask": "(9999) 99-99-99"' data-mask/>
											</div>
										</div>
                                        ...
                                        <label>Site web</label>
											<div class="input-group">
												...
												<input type="text" class="form-control" placeholder="Enter le site web" name="site_web_cli" value="<?php echo $enreg['site_web_cli']?>"/>
											</div>
										</div>
										<div class="form-group">
                                        <label>Fax</label>
											<div class="input-group">
												...
												<input type="text" class="form-control" placeholder="Enter le fax" name="fax_cli" value="<?php echo $enreg['fax_cli']?>" />
											</div>
										</div>
										
										<center><button  type="submit" class="btn btn-info">Modifier</button></center>
                                    </form>
								<?php
				...
				if(isset($_POST['raison_social']))
					...
					$sql = "update clients set raison_social = '".$raison_social."', 
					interlocuteur_cli = '".$interlocuteur_cli."' ,
					email_cli = '".$email_cli."' , 
					adresse_cli = '".$adresse_cli."' , 
					ville_cli = '".$ville_cli."' ,
					tel_cli = '".$tel_cli."' , 
					site_web_cli = '".$site_web_cli."' ,
					fax_cli= '".$fax_cli."' 
					where id_cli ='".$_GET['id']."' ;";
