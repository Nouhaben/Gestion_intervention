            ...
            <aside class="right-side">
                ...
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active"><a href="calendar.php">Tableau de bord - matériel</a></li>
                    </ol>
                </section>
                        ...
                        <div class="col-lg-12 col-xs-12">
                            ...
                            <div class="small-box bg-yellow">
                                <div class="inner">
                                    ...
                                    <p>
                                        Total clients inscrits : <h3> <?php echo count($enr['id_mat']); ?> </h3>
                                    </p>
                                </div>
                                <div class="icon">
                        ...
                        <section class="col-lg-12 connectedSortable"> 
                            ...
                            <div class="box box-warning" id="loading-example">
                                <div class="box-header">
                                    ...
                                    <h3 class="box-title">Informations sur les matériels</h3>
                                </div><!-- /.box-header -->
                                <div class="box-body warning">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-12">
                                            <div class="pad">
                                                ...
                                                <div class="clearfix">
													...
													$materiel_inscrits = array_count_values($enr['date_inscription']);
													if(isset($materiel_inscrits[date('Y-m-d')])){
														echo $materiel_inscrits[date('Y-m-d')]; 
													}else{
													 echo "Aucun matériel n'est inscrit aujourd'hui."; 
													 }
													?></small>
                                                </div>
                                                <div class="progress">
                                                ...
                                                <div class="clearfix">
                                                    ...
                                                    <small class="pull-right"><?php
														 $semaine = isset($materiel_inscrits[strftime("%Y-%m-%d", strtotime(date('Y-m-d')) - 60*60*24*7)]);
														 $jour6 = isset($materiel_inscrits[strftime("%Y-%m-%d", strtotime(date('Y-m-d')) - 60*60*24*6)]);
														 $jour5 = isset($materiel_inscrits[strftime("%Y-%m-%d", strtotime(date('Y-m-d')) - 60*60*24*5)]);
														 $jour4 = isset($materiel_inscrits[strftime("%Y-%m-%d", strtotime(date('Y-m-d')) - 60*60*24*4)]);
														 $jour3 = isset($materiel_inscrits[strftime("%Y-%m-%d", strtotime(date('Y-m-d')) - 60*60*24*3)]);
														 $jour2 = isset($materiel_inscrits[strftime("%Y-%m-%d", strtotime(date('Y-m-d')) - 60*60*24*2)]);
														 $jour1 = isset($materiel_inscrits[strftime("%Y-%m-%d", strtotime(date('Y-m-d')) - 60*60*24*1)]);
														 if(isset($materiel_inscrits[date('Y-m-d')])) {
															$employe = $materiel_inscrits[date('Y-m-d')]; 
														}else {
															$employe = 0;
														}
														 ...
														 if($nombretotal == 0 ) {
															echo "Aucun matériel n'est inscrit cette semaine.";
														 }else {
															echo $nombretotal;
														 }
														  ?></small>
                                                ...
                                                <div class="clearfix">
													...
													$materiel_inscrits = array_count_values($mois);
													if(isset($materiel_inscrits[date('Y-m')])){
														echo $materiel_inscrits[date('Y-m')]; 
													}else{
													 echo "Aucun matériel n'est entré ce mois."; 
													 }
													?></small>
                                                </div>
                                                <div class="progress">
