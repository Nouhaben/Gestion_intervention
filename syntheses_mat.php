                        ...
                        <div class="col-md-12">
                            ...
                            <div class="box box-solid box-info">
                                <div class="box-header">
                                    <h3 class="box-title">Consultations les matériels selon chaque clients</h3>
                                    ...
                                    <table id="example1" class="table table-bordered table-striped">
                                        <thead>
                                            <tr>
                                                ...
                                                <th>Raison social   <small class="badge pull bg-yellow"><?php echo count($enr['id_cli']); ?></small> </th>
                                                <th>Interlocuteur </th>
                                                <th>adresse </th>
                                                <th>télephone </th>
                                                <th>site web </th>
                                                <th>Consulter client</th>
                                            </tr>
                                        </thead>
                                        <tbody>
										<?php
										...
										$response = mysql_query($query) or die(mysql_error());
												...
												echo"<td>".$data['interlocuteur_cli']."<b></td>";
												echo"<td>".$data['adresse_cli'].'&nbsp'.$data['ville_cli']."<b></td>";
												echo"<td>".$data['tel_cli']."<b></td>";
												echo"<td>".$data['site_web_cli']."<b></td>";
												echo"<td><a href='tab_mat.php?id=".$data[0]."' class=\"btn btn-primary btn-xs\"  >Consulter son matériel</a></td>"; 
												echo"</tr>";	
												}
